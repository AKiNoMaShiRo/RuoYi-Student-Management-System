...
public class NationalScholarship extends BaseEntity {
    ...
    /** 必修与选修折算成绩之和排名 */
    @Excel(name = "必修与选修折算成绩之和排名")
    private int gradeRank;

    /** 必修与选修折算成绩之和排名百分比 */
    @Excel(name = "必修与选修折算成绩之和排名百分比")
    private double gradeRankRate;
    ...
    public double getGradeRankRate() {
        return gradeRankRate;
    }

    public void setGradeRankRate(double gradeRankRate) {
        this.gradeRankRate = gradeRankRate;
    }
